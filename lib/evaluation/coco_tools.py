...
borrowed from tensorflow object detection api with some minor errors fixed.
    ...
    def ComputeMetrics(
        ...
        Returns:
          1. summary_metrics: a dictionary holding:
            ...
            'Precision/mAP_small': mean average precision for small objects
                            (area < 32^2 pixels)
            'Precision/mAP_medium': mean average precision for medium sized
                            objects (32^2 pixels < area < 96^2 pixels)
            'Precision/mAP_large': mean average precision for large objects
        ...
        summary_metrics = OrderedDict([
            ...
            ('Precision/mAP_small', self.stats[3]),
            ('Precision/mAP_medium', self.stats[4]),
            ('Precision/mAP_large', self.stats[5]),
            ('Recall/AR@1', self.stats[6]),
            ('Recall/AR@10', self.stats[7]),
            ('Recall/AR@100', self.stats[8]),
            ('Recall/AR@100_small', self.stats[9]),
            ('Recall/AR@100_medium', self.stats[10]),
            ('Recall/AR@100_large', self.stats[11])
        ])
        ...
        for category_index, category_id in enumerate(self.GetCategoryIdList()):
            ...
            if all_metrics_per_category:
                per_category_ap['PrecisionByCategory/mAP/{}'.format(
                    category)] = self.category_stats[0][category_index]
                per_category_ap['PrecisionByCategory/mAP@.50IOU/{}'.format(
                    category)] = self.category_stats[1][category_index]
                per_category_ap['PrecisionByCategory/mAP@.75IOU/{}'.format(
                    category)] = self.category_stats[2][category_index]
                per_category_ap['PrecisionByCategory/mAP_small/{}'.format(
                    category)] = self.category_stats[3][category_index]
                per_category_ap['PrecisionByCategory/mAP_medium/{}'.format(
                    category)] = self.category_stats[4][category_index]
                per_category_ap['PrecisionByCategory/mAP_large/{}'.format(
                    category)] = self.category_stats[5][category_index]
                per_category_ap['RecallByCategory/AR@1/{}'.format(
                    category)] = self.category_stats[6][category_index]
                per_category_ap['RecallByCategory/AR@10/{}'.format(
                    category)] = self.category_stats[7][category_index]
                per_category_ap['RecallByCategory/AR@100/{}'.format(
                    category)] = self.category_stats[8][category_index]
                per_category_ap['RecallByCategory/AR@100_small/{}'.format(
                    category)] = self.category_stats[9][category_index]
                per_category_ap['RecallByCategory/AR@100_medium/{}'.format(
                    category)] = self.category_stats[10][category_index]
                per_category_ap['RecallByCategory/AR@100_large/{}'.format(
...
def ExportSegmentsToCOCO(image_ids,
    ...
    if output_path:
        with tf.gfile.GFile(output_path, 'w') as fid:
            json.dump(segment_export_list, fid, indent=2)
...
def ExportKeypointsToCOCO(image_ids,
    ...
    if output_path:
        with tf.gfile.GFile(output_path, 'w') as fid:
            json.dump(keypoints_export_list, fid, indent=2)
