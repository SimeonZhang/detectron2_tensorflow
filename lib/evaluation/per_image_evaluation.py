...
from ..structures import np_box_list
from ..structures import np_box_list_ops
from ..structures import np_box_mask_list
from ..structures import np_box_mask_list_ops


class PerImageDetectionEvaluation(object):
    ...
    def __init__(
        ...
        """Initialized PerImageDetectionEvaluation by evaluation parameters.
        Args:
    ...
    def _compute_tp_fp_for_single_class(
        ...
        scores = np.concatenate(
            [scores[~is_matched_to_difficult_box & ~is_matched_to_group_of_box], scores_group_of]
        )
